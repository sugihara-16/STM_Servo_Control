...
#define MAX_APPLICATION_SPEED_RPM       9000 /*!< rpm, mechanical */
...
#define PID_TORQUE_KP_DEFAULT         3640
#define PID_TORQUE_KI_DEFAULT         3034
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           3640
#define PID_FLUX_KI_DEFAULT           3034
...
#define PID_SPEED_KP_DEFAULT          2572/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          158/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE1_FINAL_CURRENT           1197
/* Phase 2 */
#define PHASE2_DURATION                3636 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           1197
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           1197
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           1197
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/_RPM)
#define PHASE5_FINAL_CURRENT           1197
